                    ...
                    <div>
                        ...
                        <div class="date-share">
                            <div class="post-date" style="font-size: 25px; font-weight:600;">Coordinator:
                                <a href="/faculty">{{ $singleProgram->coordinator }}</a>
                ...
                @foreach ($otherPrograms as $otherProgram)
                    <div class="latest-posts-post">
                        <div class="recent-posts-title">
                            <a class="text-danger font-weight-bold text-lg-left" style="font-size: 20px"
                                href="/programs/{{ $otherProgram->id }}">{{ $otherProgram->title }}</a>
                        </div>
                    </div>
                    <hr>
                @endforeach
